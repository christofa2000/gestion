/**
 * Componente: Filtros de Profesionales
 * 
...
interface ProfesionalesFiltersProps {
  initialSearch: string
  initialEstado: string
}

export function ProfesionalesFilters({ initialSearch, initialEstado }: ProfesionalesFiltersProps) {
